...
public class VectorBestias {
    ...
    private Bestia[] bestias = {new Orco("Ghethrof"), new Orco("Srocri"), new Orco("Krarzegh"), new Orco("Bruzgaf"), 
                                new Orco("Gorged"), new Trasgo("Uthru"), new Trasgo("Augdu"), 
...
/* 
        ...
        Bestia orco3 = new Orco("Krarzegh");
        Bestia orco4 = new Orco("Bruzgaf");
        Bestia orco5 = new Orco("Gorged");

        Bestia trasgo1 = new Trasgo("Uthru");
        Bestia trasgo2 = new Trasgo("Augdu");
        Bestia trasgo3 = new Trasgo("Augzush");
        Bestia trasgo4 = new Trasgo("Aucbo");
        Bestia trasgo5 = new Trasgo("Auharg");
